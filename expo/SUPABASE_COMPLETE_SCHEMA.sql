...
-- Add RLS (Row Level Security) - Allow all operations for authenticated and anonymous users
...
BEGIN
  ...
  RAISE NOTICE '📊 Created 13 tables with proper indexes and RLS policies';
